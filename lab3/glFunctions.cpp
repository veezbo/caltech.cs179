...
void initLights()
{
    ...
    GLfloat lightpos[]= { 4000.f, 1000.f, -5000.0f, 1.0f };
...
void initMaterial()
{
    ...
    GLfloat emitb[] = {0.0, 0.0, 0.0, 1.0};
    GLfloat  ambb[] = {0.0, 0.0, 0.0, 1.0};
    GLfloat diffb[] = {0.1, 0.1, 0.3, 1.0};
    GLfloat specb[] = {0.3, 0.3, 0.4, 1.0};
    GLfloat shinyb = 10.0f;
    
    glMaterialfv(GL_BACK, GL_AMBIENT, ambb);
    glMaterialfv(GL_BACK, GL_DIFFUSE, diffb);
    glMaterialfv(GL_BACK, GL_SPECULAR, specb);
    glMaterialfv(GL_BACK, GL_EMISSION, emitb);
    glMaterialfv(GL_BACK, GL_SHININESS, &shinyb);
}
...
//--------------------------------------------------------------------------
void renderFullscreenQuad(int w, int h)
{
